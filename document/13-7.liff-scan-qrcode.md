...
- LIFF SDK จะต้องเป็น v2.15.0 หรือใหม่กว่า
- Screen size ของ LIFF app ที่สร้างจะต้องกำหนดขนาดเป็นแบบ Full
- แอป LINE ของผู้ใช้งานจะต้องเป็น v11.7.0 หรือใหม่กว่า
- สำหรับผู้ใช้ iOS จะต้องอัพเดท OS เป็น 14.3 หรือใหม่กว่า ส่วน Android ได้ทุก Version
- สำหรับ External browser จะต้องรองรับ WebRTC โดยสามารถตรวจสอบได้จากการเปิดเว็บ (What Web Can Do Today)[https://whatwebcando.today/] แล้วดูในหัวข้อที่ชื่อ Real-Time Communication
